...
export default function TopicDetail({ 
  ...
  return (
    <section className="glass w-full max-w-2xl mx-auto p-5 sm:p-8 rounded-[2rem] animate-slide-up space-y-5 border-white/10 shadow-xl relative overflow-hidden">
      <button 
        onClick={onBack}
        className="flex items-center gap-2 text-[10px] font-bold tracking-widest text-gray-500 hover:text-foreground mb-4 transition-colors"
      >
        ← Back to topics
      </button>
